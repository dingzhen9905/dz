...
var URL = (function(url){
	var _res = {
		...
		urltime : ["http://www.vltime.cn/vl8-web/"],
                    // http://172.168.14.15:8080/vl8-web/
		url192  : ["http://106.53.73.158:8080/vl8-web/",   "192", "本地版本","http://172.168.14.15:8083/mypath/"],
...
var VlAjax = {
	...
	picture : function(){
	    return VlCfg.imgPath.split("m")[0].slice(0,-1)
	},
...
var Vlfrom = {
	file : function (){	
		return  VlCfg.SYSURL + "File/upload"
	}
}
var VlAjaxImgload={
...
//				console.log(JSON.stringify(_data))
				if(_data.code == "0"){
			        ...
			        oData=_data.data
			     	...
			     	file = oData["成功"]				
			     	var local_vdsa402newPath = '_doc/Vlbfile/'+file; //
//					console.log(JSON.stringify(local_vdsa402newPath))
